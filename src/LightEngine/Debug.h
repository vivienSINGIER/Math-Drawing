...
public:
    ...
    static void DrawText(float x, float y, const std::string& text, const sf::Color& color, float size = 10.0f, bool ui = false);
    static void DrawText(float x, float y, const std::string& text, float ratioX, float ratioY, const sf::Color& color, float size = 10.0f, bool ui = false);
